                ...
                <div class="card-body">
                    <form action="{{ route('Simpan-kelas') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" id="Fasilitas" name="Fasilitas" class="form-control" placeholder="Fasilitas">
                            </div>
                            <div class="form-group">
                            <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Simpan Data</button>
                            </div>
                </div>
